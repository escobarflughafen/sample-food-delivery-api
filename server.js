    ...
    restaurants: () => {
      return new Promise((resolve, reject) => {
        const sql = `
          SELECT
            r.*,
            m.id AS menuItem_id, m.name AS menuItem_name, m.description AS menuItem_description, m.price AS menuItem_price,
            rev.id AS review_id, rev.rating AS review_rating, rev.comment AS review_comment, rev.userId AS review_userId
          FROM restaurants r
